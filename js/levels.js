...
export const LEVEL_MAPS = {
  ...
  8: {
    walls: [
      ...
      // 가로벽
      { x: 200, y: 600, width: 300, height: 50 },
      { x: 400, y: 200, width: 300, height: 50 },
      { x: 600, y: 500, width: 400, height: 50 },
      { x: 800, y: 300, width: 250, height: 50 },
      { x: 1056, y: 400, width: 350, height: 50 },
      // 세로벽
      { x: 200, y: 175, width: 50, height: 100 },
      { x: 550, y: 625, width: 50, height: 100 },
      { x: 600, y: 225, width: 50, height: 100 },
      { x: 775, y: 575, width: 50, height: 100 },
      { x: 900, y: 150, width: 50, height: 100 },
    ],
    obstacles: [ // 6개
      { x: 300, y: 550 },
      { x: 500, y: 150 },
  ...
  9: {
    walls: [
      ...
      { x: 25, y: 360, width: 50, height: 720 },
      { x: 1255, y: 360, width: 50, height: 720 },
      { x: 200, y: 650, width: 300, height: 50 },
      { x: 600, y: 550, width: 400, height: 50 },
      { x: 1050, y: 450, width: 350, height: 50 },
      { x: 800, y: 350, width: 250, height: 50 },
      { x: 400, y: 250, width: 300, height: 50 },
      { x: 900, y: 150, width: 300, height: 50 },
      // 세로벽
      { x: 350, y: 700, width: 50, height: 100 },
      { x: 800, y: 600, width: 50, height: 200 },
      { x: 1100, y: 500, width: 50, height: 200 },
      { x: 600, y: 400, width: 50, height: 200 },
      { x: 200, y: 300, width: 50, height: 200 },
      { x: 1050, y: 250, width: 50, height: 200 },
      { x: 640, y: 100, width: 50, height: 100 }
    ],
    obstacles: [
    ]
  },
