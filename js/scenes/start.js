export default class StartScene extends Phaser.Scene {
  ...
  create() {
    this.add.image(640, 360, 'startBackground').setScale(1280 / 1920, 720 / 1080);
    const title = this.add.image(640, -200, 'title').setScale(0.8);
    this.tweens.add({ targets: title, y: 150, duration: 2000, ease: 'Bounce.easeOut'});
    const startPlayer = this.add.sprite(640, 370, 'startPlayer').setScale(0.8);
    ...
    const startButton = this.add.image(640, 600, 'startButton').setScale(0.7).setInteractive({ cursor: 'pointer' });
